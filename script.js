...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Insert ads at various locations
    insertAds();
...
function insertAds() {
    ...
    if (header) {
        ...
        topAd.className = 'ad-container top-ad';
        topAd.innerHTML = `
            <!-- JuicyAds v3.0 -->
            <script type="text/javascript" data-cfasync="false" async src="https://poweredby.jads.co/js/jads.js"></script>
            <ins id="1095571" data-width="616" data-height="298"></ins>
            <script type="text/javascript" data-cfasync="false" async>(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1095571});</script>
            <!--JuicyAds END-->
        `;
        header.parentNode.insertBefore(topAd, header);
    }

    // Ad below nav bar
    const main = document.querySelector('main');
    if (main) {
        const navBottomAd = document.createElement('div');
        navBottomAd.className = 'ad-container nav-bottom-ad';
        navBottomAd.innerHTML = `
            <!-- JuicyAds v3.0 -->
            <script type="text/javascript" data-cfasync="false" async src="https://poweredby.jads.co/js/jads.js"></script>
            ...
            <!--JuicyAds END-->
        `;
        main.parentNode.insertBefore(navBottomAd, main);
    }

    // Ad before videos section
    const videoSection = document.querySelector('.video-section');
    if (videoSection) {
        const preVideosAd = document.createElement('div');
        preVideosAd.className = 'ad-container pre-videos-ad';
        preVideosAd.innerHTML = `
            <!-- JuicyAds v3.0 -->
            <script type="text/javascript" data-cfasync="false" async src="https://poweredby.jads.co/js/jads.js"></script>
            <ins id="1095571" data-width="616" data-height="298"></ins>
            <script type="text/javascript" data-cfasync="false" async>(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1095571});</script>
            <!--JuicyAds END-->
        `;
        videoSection.parentNode.insertBefore(preVideosAd, videoSection);
    }

    // Ad after videos section
    if (videoSection) {
        const postVideosAd = document.createElement('div');
        postVideosAd.className = 'ad-container post-videos-ad';
        postVideosAd.innerHTML = `
            <!-- JuicyAds v3.0 -->
            <script type="text/javascript" data-cfasync="false" async src="https://poweredby.jads.co/js/jads.js"></script>
            <ins id="1095571" data-width="616" data-height="298"></ins>
            <script type="text/javascript" data-cfasync="false" async>(adsbyjuicy = window.adsbyjuicy || []).push({'adzone':1095571});</script>
            <!--JuicyAds END-->
        `;
        videoSection.parentNode.insertBefore(postVideosAd, videoSection.nextSibling);
    }

    // Ad after models section
    const modelSection = document.querySelector('.model-section');
    if (modelSection) {
        const postModelsAd = document.createElement('div');
        postModelsAd.className = 'ad-container post-models-ad';
        postModelsAd.innerHTML = `
            <!-- JuicyAds Native Interstitals v1.0 -->
            <script type="text/javascript" data-id="juicyads-native-ads" data-ad-zone="1095573" data-targets="a" src="https://js.juicyads.com/juicyads.native-ads.min.js"></script>
        `;
        modelSection.parentNode.insertBefore(postModelsAd, modelSection.nextSibling);
    }
    ...
    if (footer) {
        ...
        bottomAd.className = 'ad-container bottom-ad';
        bottomAd.innerHTML = `
            <!-- JuicyAds v3.0 -->
            <script type="text/javascript" data-cfasync="false" async src="https://poweredby.jads.co/js/jads.js"></script>
            <ins id="1095549" data-width="300" data-height="100"></ins>
